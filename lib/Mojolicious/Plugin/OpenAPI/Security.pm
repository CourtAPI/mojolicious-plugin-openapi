...
sub register {
  ...
  return unless $openapi->validator->get($DEF_PATH{$openapi->validator->openapi_version});
...
sub _build_action {
  ...
  my $definitions = $openapi->validator->get($DEF_PATH{$openapi->validator->openapi_version});
